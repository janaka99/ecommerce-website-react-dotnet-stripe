...
function page({}: Props) {
  ...
  return (
    <div className="flex-grow flex justify-center items-center ">
      <div className="bg-neutral-800  p-8 rounded shadow-md w-full max-w-[420px]">
        <h2 className="text-4xl font-semibold ">Add new Category</h2>
        <form onClick={handleRegister} className="flex flex-col gap-8">
          <div className="">
            <label
              htmlFor="username"
